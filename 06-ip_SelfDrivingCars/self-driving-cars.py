...
S = 2*len(PeopleLocation)-1 #minus 1 since we don't have to go back to the starting point 
# list of stages
...
mSDC.write('self-driving-cars.lp', io_options={'symbolic_solver_labels': True})
