...
def eAssignation1(mBurrito,i):
    return sum(mBurrito.vY[i,j] for j in mBurrito.j) <= 1
...
mBurrito.write('burrito.lp', io_options={'symbolic_solver_labels': True})
...
plt.axis('off')
plt.savefig('burrito-challange-day1.png',dpi=500)
plt.show
